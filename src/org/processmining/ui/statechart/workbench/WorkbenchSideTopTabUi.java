...
public class WorkbenchSideTopTabUi extends BasicTabbedPaneUI {

    private static final int Offset = 3;
//    private static final int Width = 3;
    private static final int Height = 3;
    private static final int TextOffset = 7;
    
    @Override
    protected void installDefaults() {
        super.installDefaults();
        tabInsets = new Insets(5, 5, 11, 5);
...
//            }
    ...
    private Polygon _tabBar(int x, int y, int w, int h) {
        ...
        p.addPoint(Offset + x + w, Offset + y + h - Height);
        p.addPoint(Offset + x, Offset + y + h - Height);
