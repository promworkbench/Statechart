...
public class PropertyCaseFrequency extends PropertyInteger {

    private static final long serialVersionUID = 3774234048290330340L;
    ...
    public static void setValue(Node node, int value)
        ...
        node.setIndependentProperty(PropertyCaseFrequency.class, value);
    }

    public static int getValue(Node node) throws IllegalAccessException,
            InstantiationException {
        Object value = node.getIndependentProperty(PropertyCaseFrequency.class);
        if (value != null) {
