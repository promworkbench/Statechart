...
public class DiscEPTreeListNaiveTest {
    ...
    public void testInfrequent() {
        ...
        XLog input = LogCreateTestUtil.createLogList(log);
    ...
    public void testActConcurrent() {
        ...
        IEPTree expected = EPTreeCreateUtil.create("/\\(C, /\\(A, B))");
    ...
    public void testNestedLifecycleLoopLeaf() {
        ...
        L2LListNestedCalls l2l = new L2LListNestedCalls();
